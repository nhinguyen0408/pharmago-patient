...
class AddressRepositoryImpl implements AddressRepository {
  ...
  @override
  Future<BaseResponseModel<AddressModel?>> setAddressDefault(AddressEntity address) async {
    try {
      final Map<String, dynamic> payload = {
        'default': true,
      };
      final res = await _dio.dio().put('${Api.address}${address.id}/', data: jsonEncode(payload));
      return BaseResponseModel(
        code: res.data['code'],
        message: res.data['message'],
      );
