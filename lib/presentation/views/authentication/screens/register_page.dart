...
class _RegisterPageState extends State<RegisterPage> {
                          ...
                          return Column(
                            children: [
                              ...
                              AppInput(
                                ...
                                required: true,
                                onChanged: (value) {
                                  myBloc.formRegisterChange(confirmPassword: value);
                                },
                                suffixIcon: InkWell(
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text: 'Đăng nhập ngay',
                                recognizer: TapGestureRecognizer()..onTap = () => context.router.push(const LoginRoute()),
  ...
  Future<void> _singUpHandle(BuildContext context) async {
    ...
    DialogUtils.showLoadingDialog(context, content: 'Đang đăng ký vui lòng đợi!');
